 ...
 
{
	...
	// Hide all slide images and titles
	this.slides.forEach((slide, i) => {
		if (i === this.current) {
			slide.DOM.img.classList.remove('slide__image--hidden');
			slide.DOM.title.classList.remove('slide__title--hidden');
		} else {
			slide.DOM.img.classList.add('slide__image--hidden');
			slide.DOM.title.classList.add('slide__title--hidden');
		}
	});
